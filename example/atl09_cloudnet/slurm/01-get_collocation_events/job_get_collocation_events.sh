...
(cd $run_from_dir && time python -m $script_name --dir-atl09 $sites_dir/$site/atl09 --dir-cloudnet $sites_dir/$site/cloudnet --site $site --output-dir $output_dir --job-array-index=$SLURM_ARRAY_TASK_ID)
