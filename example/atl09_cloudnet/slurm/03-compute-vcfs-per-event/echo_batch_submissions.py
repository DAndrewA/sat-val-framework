...
OUTPUT_DIR = os.path.join(MI_MAXIMISATION_RESULTS_DIRECTORY, "vcfs_per_event")
MI_MAXIMISATION_RESULTS_DIRECTORY_DIR = os.path.join(MI_MAXIMISATION_RESULTS_DIRECTORY, "vcfs_per_event_oe")
